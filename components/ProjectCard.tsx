...
function ProjectCard({
    ...
    features = [],
        ...
        return (
            <div className='flex flex-col bg-gray-100 rounded-2xl p-8 w-full h-full shadow-sm overflow-auto' >
                ...
                {features && features.length >0 && (
                    <div className='mb-6 bg-amber-300 rounded-lg p-4'>
                    ...
                    <div className='mb-6'>
                        ...
                        <div className='flex flex-wrap gap-2'>
                            {technologies.map((tech,index)=>(
                                <div key={index} className='bg-white px-3 py-1 rounded-full text-sm border border-gray-200'>
                                    {tech}
                                </div>
                            ))}
                        </div>
                ...
                <div className="flex gap-4">
                    {githubLink && (
                        <a href={githubLink} className='flex items-center gap-2 bg-white px-6 py-3 rounded-full font-medium border border-gray-200 hover:bg-gray-50 transition-colors'>
                    ...
                    {liveLink && (
                        <a href={liveLink} 
                        className="flex items-center gap-2 bg-white px-6 py-3 rounded-full font-medium border border-gray-200 hover:bg-gray-50 transition-colors"
                        >
                            Live 
